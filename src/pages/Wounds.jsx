  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Introduction Card */}
        <div className="card mb-12 bg-gradient-to-br from-red-50 to-pink-50">
              ...
              {expandedWound === wound.id && (
                <div className="mt-6 pt-6 border-t border-gray-200 space-y-4 animate-fadeIn">
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h4 className="text-lg font-bold text-purple-800 mb-2">👤 Adult Manifestations</h4>
        ...
        {/* Healing Message */}
        <div className="card mt-12 bg-gradient-to-br from-purple-600 to-pink-600 text-white">
          <h2 className="text-3xl font-bold mb-4">Remember: You Can Heal</h2>
          <p className="text-lg leading-relaxed mb-4 text-purple-100">
